...
1. Download the Online Retail Data Set from the UCI Machine Learning repository to SageMaker notebook instance. Use SageMaker notebook instance to collect, analyze, cleanse and prepare the downloaded datasets using this sample Jupyter notebook. Refer to the following diagram.
    ...
    ![img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled.png](img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled.png)
...
5. Optionally, tune the hyperparameters supported by the algorithm based on its specification. Refer to the following diagram.
    ...
    ![img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-1.png](img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-1.png)
...
9. Build request payloads for both a batch and a real-time use case and make an inference request. Both modes facilitate interactive experimentation with the trained model. Refer to the following diagram.
    ...
    ![img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-2.png](img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-2.png)
...
- [Complete SageMaker notebook](https://gist.github.com/sparsh-ai/1ba5245e195fd4fd296aaf79e0e55cc9)
...
![img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-3.png](img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-3.png)
...
![img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-4.png](img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-4.png)
...
![img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-5.png](img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-5.png)
...
![img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-6.png](img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-6.png)

Note: You cannot continue until the kernel is started. Please wait until the kernel is started before continuing !!!!

The interface would look like this:

![img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-7.png](img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-7.png)
...
![img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-8.png](img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-8.png)
...
![img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-9.png](img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-9.png)
...
![img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-10.png](img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-10.png)
...
![img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-11.png](img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-11.png)
...
![img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-12.png](img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-12.png)
...
![img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-13.png](img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-13.png)
...
![img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-14.png](img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-14.png)
...
![img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-15.png](img/_markdowns-raw-recostep-recommender-system-with-implicit-bpr-and-amazon-sa-untitled-15.png)
