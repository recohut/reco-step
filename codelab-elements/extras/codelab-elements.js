 ...
 */
     ...
     function Z(a) {
         ...
         d +=
             ...
             "</div>" +
             (e ? '<devsite-badge-to-earn badge-id="$badgeId"></devsite-badge-to-earn>' : "") +
             "</div>";
         c = U(d);
         a: {
             if (c instanceof Q) {
         ...
         b.all = function (a) {
             ...
             return e.done
                 ...
                 : new b(function (a, b) {
                       ...
                       var g = [],
                           l = 0;
                       do g.push(void 0), l++, d(e.value).m(f(g.length - 1), b), (e = c.next());
                       while (!e.done);
                   });
         };
         return b;
 ...
 (function () {
             ...
             if (0 != f.lastIndexOf("--", 0) && 0 != f.lastIndexOf("var", 0)) {
                 ...
                 if ("" == g) g = null;
                     ...
                     if (0 == ("url(" < h ? -1 : "url(" == h ? 0 : 1))
                         ...
                         0 < g.indexOf("(") &&
                             ((h = 1 < (g ? g.split("(").length - 1 : 0)) || (h = !(0 <= ta(Mc, g.substring(0, g.indexOf("(")).toLowerCase()))) || ((h = g.length - 1), (h = !(0 <= h && g.indexOf(")", h) == h))), (g = h ? null : g));
                 }
                 null != g && Hc(c, f, g);
             }
         }
     ...
     function Tc(a) {
         ...
         for (var d; (d = a.nextNode()); )
             u(c, function (a) {
                 O(uc, d, d.matches ? "matches" : "msMatchesSelector", [a.selectorText]) && a.style && Uc(d, a.style);
             });
         u(b, ic);
     }
     function Uc(a, b) {
         ...
         if (Yc) {
             ...
             if (Yc) {
                 ...
                 for (d = Vc ? new WeakMap() : new Xc(); (e = c.nextNode()); ) {
                                             ...
                                             for (var Lb = 0; (h = Kb[Lb]); Lb++)
                                                 if (h.specified) {
                                                     ...
                                                     if (0 == B.lastIndexOf("data-sanitizer-", 0)) n = null;
                                                         ...
                                                         var Mb = P(R);
                                                         S = S.value;
                                                         var Da = { tagName: v(Mb).toLowerCase(), attributeName: v(B).toLowerCase() },
                                                             Ea = { K: void 0 };
                     ...
                     if (f) {
                         if ((1 == T(f) && d.set(e, f), (e = U(e)), (g = !1), e))
                             (h = T(e)),
                                 (k = P(e).toLowerCase()),
                                 (Q = U(e)),
                                 11 != h || Q ? "body" == k && Q && (h = U(Q)) && !U(h) && (g = !0) : (g = !0),
                                 (h = null),
                                 g || !e ? (h = b) : 1 == T(e) && (h = d.get(e)),
 ...
 */
     ...
     function Cb(a) {
         cb(a.u, function (b) {
             ...
             if (d || e)
                 if ((e && (c = b), c && ((e = c.querySelector(".option-text")), (b = ""), e && (b = e.textContent), (e = c.querySelector("input")))))
                     (e.checked = !0),
                         (e = e.name),
                         (a.j[a.f][e] = b),
                         a.c.set(a.w, JSON.stringify(a.j[a.f])),
                         (b = new CustomEvent("google-codelab-action", { detail: { category: "survey", action: e.substring(0, 500), label: b.substring(0, 500) } })),
     ...
     function ob(a, b) {
         ...
         if (!Xa) {
             ...
             if (!(0 > d.keyCode || void 0 != d.returnValue)) {
                 ...
                 for (e = 0; !b.g && e < d.length; e++) (b.a = d[e]), (f = rb(d[e], a, !1, b)), (c = c && f);
             }
             return c;
         }
 ...
 */
         ...
         if (a.hasAttribute("selected")) {
             if (((b = parseInt(a.getAttribute("selected"), 0)), (b = Math.min(Math.max(0, parseInt(b, 10)), a.c.length - 1)), a.h !== b && !isNaN(b))) {
                 ...
                 a.w &&
                     a.A &&
                     a.I &&
                     (0 === b ? a.A.setAttribute("disappear", "") : a.A.removeAttribute("disappear"),
                     b === a.c.length - 1
                         ? (a.w.setAttribute("hidden", ""), a.I.removeAttribute("hidden"), Z(a, "google-codelab-action", { category: "codelab", action: "complete", label: a.s }))
                         : (a.w.removeAttribute("hidden"), a.I.setAttribute("hidden", "")));
                 a.f &&
                     a.f.querySelectorAll("li").forEach(function (a, c) {
     ...
     function Zc(a) {
         ...
         (b = a.f.querySelector("#codelab-feedback")) &&
             H(a.i, b, "click", function () {
