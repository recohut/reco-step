 ...
 */
     ...
     function tb(a) {
         ob(a.B, "google-codelab-action", function (b) {
             b = b.o.detail;
             wb({ hitType: "event", dimension1: a.A, dimension2: a.w, eventCategory: b.category, eventAction: b.action || "", eventLabel: b.label || "", eventValue: b.value || "" });
         });
 ...
 */
     ...
     function $c() {
         ...
         if (!a) return "/reco-step/";
         a = a.replace(/[^a-z0-9\-]+/gi, "");
         if (!a || "" === a.trim()) return "/reco-step/";
         "index" === a && (a = "");
